...
const HtmlcoinContractFactory_1 = require("./HtmlcoinContractFactory");
...
async function deployFromJson(wallet, contractJson, args, overrideOptions) {
    ...
    const factory = new HtmlcoinContractFactory_1.HtmlcoinContractFactory(contractJson.abi, bytecode, wallet);
