...
import { configureHtmlcoinAddressGeneration, checkTransactionType, serializeTransaction } from './helpers/utils';
...
export class HtmlcoinWallet extends IntermediateWallet {
    ...
    async signTransaction(transaction) {
        ...
        if (transactionType === GLOBAL_VARS.DEPLOY_ERROR) {
            return logger.throwError("You cannot send HTMLCOIN while deploying a contract. Try deploying again without a value.", Logger.errors.NOT_IMPLEMENTED, {
