...
import {
    configureHtmlcoinAddressGeneration,
...
// Htmlcoin core wallet and electrum use coin 17
export const HTMLCOIN_BIP44_PATH = "m/44'/172'/0'/0/0";
...
export interface HtmlcoinWalletOptions {
    ...
    // this allows sent transactions to be included in a block and show up in htmlcoind apis
...
export class HtmlcoinWallet extends IntermediateWallet {
    ...
    private opts: HtmlcoinWalletOptions;
    private readonly htmlcoinProvider?: HtmlcoinProvider;
    ...
    constructor(privateKey: any, provider?: any, opts?: HtmlcoinWalletOptions) {
        ...
        this.opts = opts || {} as HtmlcoinWalletOptions;
    }

    protected async serializeTransaction(utxos: Array<any>, neededAmount: string, tx: HtmlcoinTransactionRequest, transactionType: number, opts?: SerializeOptions): Promise<string> {
     ...
     */
    async signTransaction(transaction: HtmlcoinTransactionRequest): Promise<string> {
    ...
    static fromMnemonic(mnemonic: string, path?: string, wordlist?: Wordlist): IntermediateWallet {
        ...
        return new HtmlcoinWallet(configureHtmlcoinAddressGeneration(hdnode));
    }
}
