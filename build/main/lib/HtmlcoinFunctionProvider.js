...
exports.HtmlcoinFunctionProvider = void 0;
const HtmlcoinProvider_1 = require("./HtmlcoinProvider");
class HtmlcoinFunctionProvider extends HtmlcoinProvider_1.HtmlcoinProvider {
    constructor(fn) {
        super();
        this.fn = fn;
    }
...
exports.HtmlcoinFunctionProvider = HtmlcoinFunctionProvider;
