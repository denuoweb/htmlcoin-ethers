...
const {
    HtmlcoinContractFactory,
} = require("../../build/main/lib/HtmlcoinContractFactory");
...
const signerNoCache = new HtmlcoinWallet(
    "99dda7e1a59655c9e02de8592be3b914df7df320e72ce04ccf0427f9a366ec6e",
    provider,
    {
...
const signerNoHtmlcoin = new HtmlcoinWallet(
...
describe("HtmlcoinWallet", function () {
    ...
    it("HtmlcoinWallet allows specifying/ignoring inputs", async function() {
        ...
        const ignoredInputsSigner = new HtmlcoinWallet(
            "99dda7e1a59655c9e02de8592be3b914df7df320e72ce04ccf0427f9a366ec6e",
            provider,
            {
                disableConsumingUtxos: true,
    ...
    it("allows enforces hashes of inputs as nonce", async function() {
        ...
        const nonceSigner = new HtmlcoinWallet(
            "99dda7e1a59655c9e02de8592be3b914df7df320e72ce04ccf0427f9a366ec6e",
            provider,
            {
                disableConsumingUtxos: true,
        ...
        const nonceSignerIgnoredInputs = new HtmlcoinWallet(
            "99dda7e1a59655c9e02de8592be3b914df7df320e72ce04ccf0427f9a366ec6e",
            provider,
            {
                disableConsumingUtxos: true,
        ...
        success = true;
        try {
            const signerIgnoredInputs = new HtmlcoinWallet(
                "99dda7e1a59655c9e02de8592be3b914df7df320e72ce04ccf0427f9a366ec6e",
                provider,
                {
                    disableConsumingUtxos: true,
