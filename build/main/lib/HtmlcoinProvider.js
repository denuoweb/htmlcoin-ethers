...
exports.compareVersion = exports.HtmlcoinProviderSubprovider = exports.HtmlcoinWebSocketProvider = exports.HtmlcoinJsonRpcProvider = exports.HtmlcoinProvider = void 0;
const ethers_1 = require("ethers");
const utils_1 = require("./helpers/utils");
const logger_1 = require("@ethersproject/logger");
const logger = new logger_1.Logger("htmlcoin-ethers");
const properties_1 = require("@ethersproject/properties");
class HtmlcoinProvider extends HtmlcoinProviderMixin(ethers_1.providers.JsonRpcProvider) {
}
exports.HtmlcoinProvider = HtmlcoinProvider;
;
class HtmlcoinJsonRpcProvider extends HtmlcoinProviderMixin(ethers_1.providers.JsonRpcProvider) {
}
exports.HtmlcoinJsonRpcProvider = HtmlcoinJsonRpcProvider;
;
class HtmlcoinWebSocketProvider extends HtmlcoinProviderMixin(ethers_1.providers.WebSocketProvider) {
}
exports.HtmlcoinWebSocketProvider = HtmlcoinWebSocketProvider;
;
...
class HtmlcoinProviderSubprovider extends HtmlcoinProviderMixin(ProviderSubprovider) {
}
exports.HtmlcoinProviderSubprovider = HtmlcoinProviderSubprovider;
;
function HtmlcoinProviderMixin(Base) {
    return class HtmlcoinProviderMixin extends Base {
        ...
        async getClientVersion() {
            ...
            if (version === "HTMLCOIN ETHTestRPC/ethereum-js") {
