...
const logger = new Logger("htmlcoin-ethers");
...
export class HtmlcoinProvider extends HtmlcoinProviderMixin(providers.JsonRpcProvider) {};
export class HtmlcoinJsonRpcProvider extends HtmlcoinProviderMixin(providers.JsonRpcProvider) {};
export class HtmlcoinWebSocketProvider extends HtmlcoinProviderMixin(providers.WebSocketProvider) {};
...
export class HtmlcoinProviderSubprovider extends HtmlcoinProviderMixin(ProviderSubprovider) {};

function HtmlcoinProviderMixin<TBase extends Constructor>(Base: TBase) {
