...
export declare function configureHtmlcoinAddressGeneration(hdnode: HDNode): HDNode;
export declare function checkTransactionType(tx: TransactionRequest): CheckTransactionType;
export declare function serializeTransaction(utxos: Array<any>, fetchUtxos: Function, neededAmount: string, tx: HtmlcoinTransactionRequest, transactionType: number, privateKey: string, publicKey: string, opts?: SerializeOptions): Promise<string>;
export declare function serializeTransactionWith(utxos: Array<any>, fetchUtxos: Function, neededAmount: string, tx: HtmlcoinTransactionRequest, transactionType: number, signer: Function, publicKey: string, opts?: SerializeOptions): Promise<string>;
/**
...
export declare const messagePrefix = "\u0015Htmlcoin Signed Message:\n";
