...
const compressedSigner = new HtmlcoinWallet("L1je6aiLCNwPNeeGwgSBfDcobnokp64HzaUZGBV7dZQB1fmsCSBR", provider);
const uncompressedSigner = new HtmlcoinWallet("5KJm4eP8sAwW6J29LpMpJsEPJJMWaNdfY12RFN4Vsyoj6qfKe64", provider);
    ...
    describe("Encoding Decoding Signatures", function () {
        ...
        for (let i = 0; i < signers.length; i++) {
            describe(signers[i].name, function () {
                ...
                describe("VRS - (Htmlcoin Signature Format)", function () {
