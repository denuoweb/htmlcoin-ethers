...
export interface IdempotentRequest {
    nonce: string;
    inputs: Array<string>;
    transaction: HtmlcoinTransactionRequest;
...
export interface Idempotent {
    ...
    sendTransactionIdempotent(transaction: Deferrable<HtmlcoinTransactionRequest>): Promise<IdempotentRequest>;
}
export declare type HtmlcoinTransactionRequest = TransactionRequest & {
    inputs?: Array<string>;
};
