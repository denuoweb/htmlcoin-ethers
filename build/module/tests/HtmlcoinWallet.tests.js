...
const { HtmlcoinWallet } = require("../../build/main/lib/HtmlcoinWallet");
const { HtmlcoinProvider } = require("../../build/main/lib/HtmlcoinProvider");
const { HtmlcoinContractFactory, } = require("../../build/main/lib/HtmlcoinContractFactory");
const { generateContractAddress, computeAddress } = require('../../build/main/lib/helpers/utils');
const HRC20_BYTECODE = "";
...
const signer = new HtmlcoinWallet("99dda7e1a59655c9e02de8592be3b914df7df320e72ce04ccf0427f9a366ec6e", provider);
const signerNoCache = new HtmlcoinWallet("99dda7e1a59655c9e02de8592be3b914df7df320e72ce04ccf0427f9a366ec6e", provider, {
    disableConsumingUtxos: true,
});
// hash160PubKey/address -> 0x30a41759e2fec594fbb90ea2b212c9ef8074e227
const signerNoHtmlcoin = new HtmlcoinWallet("61fd08e21110d908cf8dc20bb243a96e2dc0d29169b4fec09594c39e4384125a", provider);
describe("HtmlcoinWallet", function () {
    it("supports compressed private keys", async function () {
        ...
        for (const { privateKey, hex, compressed } of privateKeys) {
            const htmlcoinWallet = new HtmlcoinWallet(privateKey);
            expect(htmlcoinWallet.address).to.equal(hex, "Got incorrect address from private key: " + privateKey);
        }
    });
    ...
    it("HtmlcoinWallet allows specifying/ignoring inputs", async function () {
        const a = await signerNoCache.sendTransactionIdempotent({
            to: "0x7926223070547D2D15b2eF5e7383E541c338FfE9",
            from: signer.address,
            gasLimit: "0x3d090",
        ...
        const ignoredInputsSigner = new HtmlcoinWallet("99dda7e1a59655c9e02de8592be3b914df7df320e72ce04ccf0427f9a366ec6e", provider, {
            disableConsumingUtxos: true,
    ...
    it("allows enforces hashes of inputs as nonce", async function () {
        ...
        const nonceSigner = new HtmlcoinWallet("99dda7e1a59655c9e02de8592be3b914df7df320e72ce04ccf0427f9a366ec6e", provider, {
            disableConsumingUtxos: true,
            nonce: a.nonce,
        });
        ...
        const nonceSignerIgnoredInputs = new HtmlcoinWallet("99dda7e1a59655c9e02de8592be3b914df7df320e72ce04ccf0427f9a366ec6e", provider, {
            disableConsumingUtxos: true,
            nonce: a.nonce,
            ignoreInputs: a.inputs,
        });
        ...
        success = true;
        try {
            const signerIgnoredInputs = new HtmlcoinWallet("99dda7e1a59655c9e02de8592be3b914df7df320e72ce04ccf0427f9a366ec6e", provider, {
                disableConsumingUtxos: true,
                ignoreInputs: a.inputs,
            });
    ...
    it("can connect to SimpleBank and call a payable method", async function () {
        const simpleBank = new HtmlcoinContractFactory(SIMPLEBANK_ABI, SIMPLEBANK_BYTECODE, signer);
    ...
    it("can connect to HRC20 ", async function () {
        const hrc20 = new HtmlcoinContractFactory(HRC20_ABI, HRC20_BYTECODE, signer);
        const deployment = await hrc20.deploy({
            gasLimit: "0x2dc6c0", gasPrice: "0x190"
        });
        expect(deployment.address).to.equal(`0x${generateContractAddress(deployment.deployTransaction.hash.split("0x")[1])}`);
        const tx = await deployment.deployed();
        const hrc200 = new ethers.Contract(tx.address, HRC20_ABI, signer);
        const name = await hrc200.name({ gasPrice: "0x190" });
        console.log(name, tx.address);
        expect(name).to.equal("QRC TEST");
    });
    it("can transfer HRC20 ", async function () {
        const hrc20 = new HtmlcoinContractFactory(HRC20_ABI, HRC20_BYTECODE, signer);
        const deployment = await hrc20.deploy({
            gasLimit: "0x2dc6c0", gasPrice: "0x190"
        });
        ...
        const tx = await deployment.deployed();
        const hrc200 = new ethers.Contract(tx.address, HRC20_ABI, signer);
        await hrc200.transfer("0x30a41759e2fec594fbb90ea2b212c9ef8074e227", 1, { gasPrice: "0x190" });
        // console.log(name, tx.address)
        // expect(name).to.equal("QRC TEST");
    });
});
